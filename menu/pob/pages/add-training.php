...
if(isset($_POST["submit"]))
{
	...
	$sql = "INSERT INTO training_detail (b_title, b_desc) VALUES ('" .$b_title. "', '" .$b_desc. "')";
	mysql_query($sql);
	...
	header("location:?go=add-training&add=ok");
}
...
<div class="row">
  ...
  <div id="content" class="col-lg-10 col-sm-10">
    ...
    <div class="row">
      <?php if($_GET["add"]  == "ok"){?>
      <div class="alert alert-info">Training Details Added Successfully.</div>
      <?php } ?>
      <div class="box col-md-12">
        <div class="box-inner">
          <div class="box-header well" data-original-title="">
            <h2><i class="glyphicon glyphicon-edit"></i> Add Training</h2>
          </div>
