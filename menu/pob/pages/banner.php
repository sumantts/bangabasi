...
if($_GET["id"])
{
	...
	$old_file1 = "banner_images/".$row_fotu["banner_name"];
	if(file_exists($old_file1)){unlink($old_file1);}
		
	mysql_query("DELETE FROM banner_images WHERE id =".$id);
...
<div class="ch-container">
    ...
    <tr>
		...
		<td class="">
		<img src="banner_images/<?php if($row_fotu["banner_name"]){echo $row_fotu["banner_name"];}?>" width="300px;" height="75px;" />
		</td>
