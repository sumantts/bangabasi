...
if(isset($_POST["submit"]))
{
	...
	$sql = "INSERT INTO products (b_title, b_desc, img_name) VALUES ('" .$b_title. "', '" .$b_desc. "', '')";
	mysql_query($sql);
	...
	header("location:?go=add-products&add=ok");
}
...
<div class="row">
  ...
  <div id="content" class="col-lg-10 col-sm-10">
    ...
    <div class="row">
      <?php if($_GET["add"]  == "ok"){?>
      <div class="alert alert-info">Products Added Successfully.</div>
      <?php } ?>
