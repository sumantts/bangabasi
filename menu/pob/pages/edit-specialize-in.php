...
if(isset($_GET["id"])){
	$id = $_GET["id"];
	$fetch_fotu = "SELECT * FROM specialization WHERE id = '" .$id. "'";
...
if(isset($_POST["submit"]))
{
	...
	$sql = "UPDATE specialization SET b_title = '" .$b_title. "', b_desc = '" .$b_desc. "' WHERE id = '" .$id. "'";
	mysql_query($sql);
	...
	header("location:?go=edit-specialize-in&add=ok&id=$id");
}
  ...
  <div id="content" class="col-lg-10 col-sm-10">
    ...
    <div>
      <ul class="breadcrumb">
		...
		<li> <a href="">Edit Specialize In</a> </li>
      </ul>
    </div>
    <div class="row">
      <?php if($_GET["add"]  == "ok"){?>
      <div class="alert alert-info">Specialization Updated Successfully.</div>
      <?php } ?>
      <div class="box col-md-12">
        <div class="box-inner">
          <div class="box-header well" data-original-title="">
            <h2><i class="glyphicon glyphicon-edit"></i> Edit Specialization</h2>
          </div>
