    ...
    <td><table border="0" width="100%">
      ...
      <table width="100%">
        <tr>
          ...
          <th align="right"><nobr>Total Rs.</nobr></th>
        </tr>
        <?php
		...
		<tr>
          <td align="left" colspan="3" style="border-top:1px dotted #000000"><nobr>Discount (in %):</nobr></td>
          <td align="right" style="border-top:1px dotted #000000"><?=$discount_percent?></td>
        </tr>
		<tr>
          ...
          <td align="right" style="border-top:1px dotted #000000"><?=$amount_after_discount?></td>
        </tr>
        <tr>
